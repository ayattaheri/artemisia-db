...
Due to issues with an older version of `sra-tools` (2.8.0), version 3.1.0 is recommended. I downloaded the latest version from Bioconda and installed it using the following command:
